 ...
 * @package			com_geocars
 * @subpackage		com_geocars.install
 * @copyright		
 ...
 */
class com_geocarsInstallerScript
{
    /**
    ...
    function install($parent) 
    {
		...
		$install_html_file = dirname(__FILE__) . '/geocars_install.html';
		...
		ob_start();            
		?>
		<div id="geocarsinstall-info">
			<h1><?php echo JText::_('COM_GEOCARS_INSTALL_HEADER'); ?></h1>
			<div id="geocarsinstall-intro">
				<?php echo JText::_('COM_GEOCARS_INSTALL_INTRO'); ?>
			</div>
			<table id="geocarsinstall-table" class="adminlist">
				<thead class="geocarsinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_GEOCARS_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="geocarsinstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_GEOCARS_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_GEOCARS_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="geocarsinstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_GEOCARS');?>
						</td>
						<td class="geocarsinstall-success">
							<?php echo JText::_('COM_GEOCARS_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_GEOCARS_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="geocarsinstall-subheading">
				<th>
					<?php echo JText::_('COM_GEOCARS_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_GEOCARS_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_GEOCARS_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="geocarsinstall-subheading">
				<th>
					<?php echo JText::_('COM_GEOCARS_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_GEOCARS_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_GEOCARS_STATUS_HEADER');?>
				</th>					
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="geocarsinstall-component-error">
									<?php echo JText::_('COM_GEOCARS_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="geocarsinstall-component-success">
									<?php echo JText::_('COM_GEOCARS_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_GEOCARS_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = dirname(__FILE__) . '/geocars_uninstall.html';
     ...
     ?>
	<div id="geocarsinstall-info">
		<h1><?php echo JText::_('COM_GEOCARS_UNINSTALL_HEADER'); ?></h1>
			<table id="geocarsinstall-table" class="adminlist">
				<thead class="geocarsinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_GEOCARS_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="geocarsinstall-row">
						...
						<td class="geocarsinstall-success">
							<?php echo JText::_('COM_GEOCARS_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/geocars'); 
		JFolder::delete(JPATH_SITE.'/plugins/geocars'); 
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="geocarsinstall-component-error">
									<?php echo JText::_('COM_GEOCARS_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="geocarsinstall-component-success">
									<?php echo JText::_('COM_GEOCARS_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="geocarsinstall-info">
			<h1><?php echo JText::_('COM_GEOCARS_UPDATE_HEADER'); ?></h1>
			<table id="geocarsinstall-table" class="adminlist">
				<thead class="geocarsinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_GEOCARS_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="geocarsinstall-row">
						...
						<td class="geocarsinstall-success">
							<?php echo JText::_('COM_GEOCARS_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="geocarsinstall-component-error">
									<?php echo JText::_('COM_GEOCARS_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="geocarsinstall-component-success">
									<?php echo JText::_('COM_GEOCARS_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_GEOCARS_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_GEOCARS_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/geocars'); 
				JFile::copy('administrator/components/com_geocars/index.html','images/geocars/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/geocars') AND !JFile::exists(JPATH_SITE.'/plugins/geocars/index.html'))
				{
					JFile::copy('administrator/components/com_geocars/index.html','plugins/geocars/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_geocars'));		
	...
	<tr class="geocarsinstall-row">
		...
		<td class="geocarsinstall-error">
			<div>
				<?php echo JText::_('COM_GEOCARS_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="geocarsinstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="geocarsinstall-row">
			...
			<td class="geocarsinstall-success">
				<div><?php echo JText::_('COM_GEOCARS_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
