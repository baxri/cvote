...
?>
<div class="cars-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_GEOCARS_CARS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_geocars&view=cars&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
		<fieldset class="filters clearfix">
			<div class="filter_search">
				<label class="filter-search-lbl" for="filter_search"><?php echo JText::_('JSEARCH_FILTER_LABEL'); ?></label>
				<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>"  onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_GEOCARS_FILTER_SEARCH_DESC'); ?>" />
