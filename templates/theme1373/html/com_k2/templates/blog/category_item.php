...
<!--Item Header - START -->
	<?php if($this->item->params->get('catItemTitle') || $this->item->params->get('catItemAuthor') || $this->item->params->get('catItemDateCreated') || $this->item->params->get('catItemRating')): ?>
	...
	<?php if($this->item->params->get('catItemCommentsAnchor') && ( ($this->item->params->get('comments') == '2' && !$this->user->guest) || ($this->item->params->get('comments') == '1')) ): ?>
		<span class="catItemCommentsLink">
			...
			<?php else: ?>
				...
				<?php else: ?>
				<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
					<?php echo $this->item->numOfComments; ?> <?php echo JText::_('K2_COMMENTS'); ?>
				</a>
				<?php endif; ?>
			<?php endif; ?>
		</span>
