...
<!-- Anchor link to comments below - if enabled -->
				...
				<?php echo JText::_('TPL_WITH'); ?>
							...
							<a class="k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
								<span><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
							</a>
							<?php else: ?>
							<a class="k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
								<span><?php echo $this->item->numOfComments; ?></span> <?php echo JText::_('K2_COMMENTS'); ?>
							</a>
							<?php endif; ?>
						<?php endif; ?>
					</span>
			...
			<?php foreach ($this->item->comments as $key=>$comment): ?>
				<li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
					...
					<?php if($comment->userImage): ?>
						<div class="userAvatar" style="width:<?php echo $this->item->params->get('commenterImgWidth'); ?>px">
					...
					<div class="commentBody">
						...
						<span class="commentDate">
							<strong><?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC8')); ?></strong>
						</span>
						
				
					</div>

							<div class="commentToolbar" style="padding:0 0 0 <?php echo $this->item->params->get('commenterImgWidth'); ?>px">
