...
/**
 * Cars list controller class.
 *
 * 
 */
class GeocarsControllerCars extends JControllerAdmin
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Car', $prefix = 'GeocarsModel',$config = array('ignore_request' => true))
	{
