 ...
 * 
 * @CAversion		Id: mod_architectcomp.php 418 2014-10-22 14:42:36Z BrianWade $
...
$list = modGeocarsHelper::getList($params);
$module_class_sfx = htmlspecialchars($params->get('moduleclass_sfx'));

require JModuleHelper::getLayoutPath('mod_geocars', $params->get('layout', 'default'));
